...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Python\Python_projects\flash-card-project-start'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Python\Python_projects\flash-card-project-start\Scripts\deactivate.nu'
